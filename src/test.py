...
async def test_collatz(dut):
    ...
    tests = [
        ...
        # expected overflows:
        (1487063479, 191, 0xbaadf00d), # 10037678488),
        (1487063479, 191, 0xbaadf00d), # 10037678488),
        (3744461465, 213, 0xbaadf00d), # 12637557448),
        (4045380941, 301, 0xbaadf00d), # 12136142824),
        (3328045995, 161, 0xbaadf00d), # 14976206980),
        (609787903, 263, 0xbaadf00d), # 600800394580),
        (3277473346, 188, 0xbaadf00d), # 4916210020),
        (1980890718, 195, 0xbaadf00d), # 10028259268),
        (3374936602, 232, 0xbaadf00d), # 5062404904),
        (1273462655, 246, 0xbaadf00d), # 43516606696),
        (1668429215, 187, 0xbaadf00d), # 72157526944),
        (1378381212, 272, 0xbaadf00d), # 13247401120),
        (2630975025, 247, 0xbaadf00d), # 182263904944),
        (3183903831, 175, 0xbaadf00d), # 21491350864),
        (3737972453, 206, 0xbaadf00d), # 11213917360),
        (3882955187, 183, 0xbaadf00d), # 17473298344),
        (2568484190, 428, 0xbaadf00d), # 13002951220),
        (1756674699, 293, 0xbaadf00d), # 9757656736),
        (1278924513, 201, 0xbaadf00d), # 14766501256),
        (2147753997, 176, 0xbaadf00d), # 6443261992),
        (3882398953, 164, 0xbaadf00d), # 29481967060),
        (2573139127, 202, 0xbaadf00d), # 17368689112),
        (2355062134, 401, 0xbaadf00d), # 42969471784),
        (3361024734, 156, 0xbaadf00d), # 19142086192),
        (471343081, 285, 0xbaadf00d), # 6040003840),
        (3533988353, 156, 0xbaadf00d), # 10601965060),
        (3585668161, 213, 0xbaadf00d), # 10757004484),
        (4139110934, 231, 0xbaadf00d), # 551788260244),
        (1903667965, 199, 0xbaadf00d), # 10841983972),
        (3535674805, 107, 0xbaadf00d), # 10607024416),
        (1133736201, 294, 0xbaadf00d), # 5739539524),
        (1565016040, 173, 0xbaadf00d), # 7623164392),
        (1991700587, 186, 0xbaadf00d), # 36339730000),
        (1391268039, 209, 0xbaadf00d), # 9391059268),
        (2018450137, 194, 0xbaadf00d), # 6812269216),
        (796021339, 301, 0xbaadf00d), # 218067215200),
        (3852828572, 288, 0xbaadf00d), # 10971531376),
        (2162764140, 189, 0xbaadf00d), # 4619106628),
        (2893424721, 316, 0xbaadf00d), # 8680274164),
        (1628671260, 191, 0xbaadf00d), # 5571759364),
        (3893436958, 195, 0xbaadf00d), # 19710524608),
        (3557777921, 231, 0xbaadf00d), # 10673333764),
    ]
